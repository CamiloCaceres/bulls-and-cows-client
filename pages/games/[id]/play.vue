<template>
  <h1 class="text-2xl font-heading text-center text-text">
    Bulls and Cows Game
  </h1>
  <div v-if="game">
    <UCard class="mt-4">
      <p v-if="game.status === 'finished'">Game Over!</p>

      <div v-else-if="game.status === 'active'">
        Guess the number!
        <div class="flex flex-col gap-2">
          <GuessInput v-model="currentGuess" />
          <UButton
          ...
          <p class="text-end text-sm text-gray-500 mt-6">
